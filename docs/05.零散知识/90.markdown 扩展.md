...
```md
<<< @/05.零散知识/snippets/snippet.js{2}
```

**Code file**

<<< @/05.零散知识/snippets/snippet.js
...
```md
<<< @/05.零散知识/snippets/snippet-with-region.js#snippet{1}
```

**Code file**

<<< @/05.零散知识/snippets/snippet-with-region.js
...
```md
<<< @/05.零散知识/snippets/snippet.cs{c#}

<!-- 带行高亮: -->

<<< @/05.零散知识/snippets/snippet.cs{1,2,4-6 c#}

<!-- 带行号: -->

<<< @/05.零散知识/snippets/snippet.cs{1,2,4-6 c#:line-numbers}
```
...
<<< @/05.零散知识/snippets/snippet-with-region.js#snippet{1,2 ts:line-numbers} [snippet with region]
